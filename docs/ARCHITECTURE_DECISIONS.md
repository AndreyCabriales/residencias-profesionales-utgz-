...
## ADR-006: Implementaci�n de Policies para prevenir IDOR

**Fecha:** Julio 2026
**Contexto:** Exist�a una vulnerabilidad cr�tica de IDOR donde un usuario malintencionado pod�a modificar la URL (ej. /asesor/documentos/5/descargar) y acceder o evaluar documentos de otros alumnos o asesores.
**Decisi�n:** Se centraliz� la l�gica de autorizaci�n creando \DocumentoPolicy\ y aplicando Route Model Binding impl�cito en las rutas. En lugar de dispersar sentencias \if\ por los controladores para validar propiedad, el controlador simplemente delega a \Gate::authorize()
**Consecuencias:**
- Reducci�n del c�digo de validaci�n en controladores.
- Protecci�n robusta y centralizada contra ataques IDOR.
- Menos propensi�n a errores humanos en futuros desarrollos.
