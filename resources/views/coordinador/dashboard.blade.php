<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 fade-in-up">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
            ...
            <div class="ml-4">
                <h3 class="text-gray-500 text-sm font-medium">Doc. Pendientes</h3>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
            ...
            <div class="ml-4">
                <h3 class="text-gray-500 text-sm font-medium">Alumnos Finalizados</h3>
                <div class="flex items-end gap-2">
                    <p class="text-2xl font-bold text-green-600">{{ $alumnosFinalizados }}</p>
                    <p class="text-sm text-gray-400 font-medium mb-1">/ {{ $totalAlumnos }}</p>
                </div>
            </div>
        </div>
    </div>
